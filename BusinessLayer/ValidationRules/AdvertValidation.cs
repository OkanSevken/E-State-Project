...
namespace BusinessLayer.ValidationRules
{
    public class AdvertValidation :AbstractValidator<Advert>
    {
        public AdvertValidation() 
        {
            ...
            RuleFor(x => x.AdvertTitle).MinimumLength(5).MaximumLength(500).WithMessage("Minumum 50 maksimum 500 karakter giriniz");
            ...
            //RuleFor(x => x.PhoneNumber).Matches(new Regex(@"([\+]90?)([ ]?)(\([0-9]{3}\))(\s*[\-]?)([0-9]{2})(\s*[\-]?)([0-9]{2})"));
        }
    }
}
